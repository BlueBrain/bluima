...
public class ElasticIndexer extends JCasAnnotator_ImplBase {
	...
	@ConfigurationParameter(name = PARAM_FLUSH_EVERY, defaultValue = "100", //
	mandatory = false, description = "how often to flush docs to ES")
	protected int flushEvery;

	public static final String PARAM_HOST = "host";
	@ConfigurationParameter(name = PARAM_HOST, defaultValue = "localhost", //
	mandatory = false, description = "the ES host name")
