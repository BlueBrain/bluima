 ...
 * @since		1.0
 */
public class SentenceSetToHTML
{
	/**
	 * Define a static logger variable so that it references the
	 * Logger instance named <code>SentenceSetToHTML</code>.
	 */
	static Logger logger = LoggerFactory.getLogger(SentenceSetToHTML.class.getName());

	//
	private ExampleSet inputSet;

	//
	public SentenceSetToHTML(File in, File out, File ans) throws Exception
	{
	...
	//
	public SentenceSetToHTML(File in, File out) throws Exception
	{
...
//		if (args.length < 1)
//		{
//			System.err.println("java -mx512M org.itc.irst.tcc.sre.data.SentenceSetToHTML test-file [ans-file]");
//			System.exit(-1);
//		}
//
...
//		if (args.length == 1)
//		{
//			new SentenceSetToHTML(in, out);
//		}
//		else if (args.length == 2)
//		{
//			File ans = new File(args[1]);
//			new SentenceSetToHTML(in, out, ans);
//		}
//
//
//	} // end main
} // end class SentenceSetToHTML
