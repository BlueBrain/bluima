...
public class Predict {
    static Logger logger = LoggerFactory.getLogger(Predict.class.getName());
    ...
    public void run() throws Exception {
        ...
        svm_predict.run(svmTestFile.getAbsolutePath(),
                svmModelFile.getAbsolutePath(), outputFile.getAbsolutePath());
