...
#SBATCH --output=/nfs4/bbp.epfl.ch/user/mazimmer/slurm-plda-20-noopt-stdout.log
#SBATCH --error=/nfs4/bbp.epfl.ch/user/mazimmer/slurm-plda-20-noopt-stderr.log
...
./plda_eval.sh $HOME/private/corpora/twenty_newsgroups 30
