...
#SBATCH --output=/nfs4/bbp.epfl.ch/user/mazimmer/slurm-dca-20-stdout.log
#SBATCH --error=/nfs4/bbp.epfl.ch/user/mazimmer/slurm-dca-20-stderr.log
...
./dca_eval.sh $HOME/private/corpora/twenty_newsgroups 30
