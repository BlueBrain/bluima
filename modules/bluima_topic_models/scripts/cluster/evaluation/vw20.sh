...
#SBATCH --output=/nfs4/bbp.epfl.ch/user/mazimmer/slurm-vw-20-stdout.log
#SBATCH --error=/nfs4/bbp.epfl.ch/user/mazimmer/slurm-vw-20-stderr.log
...
./vw_eval.sh $HOME/private/corpora/twenty_newsgroups 30
