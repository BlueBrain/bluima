...
/**
 * Filters cooccurrences whose sentence contains keywords. Improves precision at
 * the cost of recall.
 * 
 * @author renaud.richardet@epfl.ch
 */
@TypeCapability(inputs = COOCCURRENCE)
public class FilterCoocurrencesByTriggerword extends JCasAnnotator_ImplBase {
