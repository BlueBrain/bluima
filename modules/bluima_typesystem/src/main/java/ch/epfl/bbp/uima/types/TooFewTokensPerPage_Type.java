 ...
 * @generated */
public class TooFewTokensPerPage_Type extends BadContent_Type {
  /** @generated 
  ...
  public final static int typeIndexID = TooFewTokensPerPage.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ch.epfl.bbp.uima.types.TooFewTokensPerPage");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public TooFewTokensPerPage_Type(JCas jcas, Type casType) {
    super(jcas, casType);
