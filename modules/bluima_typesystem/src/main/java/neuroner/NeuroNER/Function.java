 ...
 * @generated */
public class Function extends NeuronProperty {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Function.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Function() {/* intentionally empty block */}
   ...
   */
  public Function(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Function(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
