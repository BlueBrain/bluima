 ...
 * @generated */
public class ProteinName extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ProteinName.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ProteinName() {/* intentionally empty block */}
   ...
   */
  public ProteinName(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ProteinName(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
