 ...
 * @generated */
public class NeuronTrigger extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NeuronTrigger.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NeuronTrigger() {/* intentionally empty block */}
   ...
   */
  public NeuronTrigger(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public NeuronTrigger(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public NeuronTrigger(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
