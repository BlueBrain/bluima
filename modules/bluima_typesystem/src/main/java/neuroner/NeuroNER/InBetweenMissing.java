...
public class InBetweenMissing extends Annotation {
  ...
  public final static int typeIndexID = JCasRegistry.register(InBetweenMissing.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected InBetweenMissing() {/* intentionally empty block */}
   ...
   */
  public InBetweenMissing(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public InBetweenMissing(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public InBetweenMissing(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
