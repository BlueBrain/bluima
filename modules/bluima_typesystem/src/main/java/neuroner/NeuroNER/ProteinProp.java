 ...
 * @generated */
public class ProteinProp extends NeuronProperty {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ProteinProp.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ProteinProp() {/* intentionally empty block */}
   ...
   */
  public ProteinProp(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ProteinProp(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
