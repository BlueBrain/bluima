 ...
 * @generated */
public class ProteinTrigger extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ProteinTrigger.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ProteinTrigger() {/* intentionally empty block */}
   ...
   */
  public ProteinTrigger(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ProteinTrigger(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ProteinTrigger(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
