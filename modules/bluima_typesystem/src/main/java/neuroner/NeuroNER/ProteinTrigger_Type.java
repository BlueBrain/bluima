...
public class ProteinTrigger_Type extends Annotation_Type {
  ...
  public final static int typeIndexID = ProteinTrigger.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("neuroner.NeuroNER.ProteinTrigger");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public ProteinTrigger_Type(JCas jcas, Type casType) {
    super(jcas, casType);
