...
public class Name_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jules.types.ace.Name");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "de.julielab.jules.types.ace.Name");
