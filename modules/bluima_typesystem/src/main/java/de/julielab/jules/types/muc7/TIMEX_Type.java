...
public class TIMEX_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     FeatureStructure fs = TIMEX_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new TIMEX(addr, TIMEX_Type.this);
  			   TIMEX_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new TIMEX(addr, TIMEX_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = TIMEX.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jules.types.muc7.TIMEX");
  ...
  public String getTypeOfNE(int addr) {
      ...
      jcas.throwFeatMissing("typeOfNE", "de.julielab.jules.types.muc7.TIMEX");
  ...
  public String getMin(int addr) {
      ...
      jcas.throwFeatMissing("min", "de.julielab.jules.types.muc7.TIMEX");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public TIMEX_Type(JCas jcas, Type casType) {
    super(jcas, casType);
