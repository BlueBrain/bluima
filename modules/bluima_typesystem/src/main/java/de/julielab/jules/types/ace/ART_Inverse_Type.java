 ...
 * @generated */
public class ART_Inverse_Type extends RelationMention_Type {
  /** @generated 
  ...
  public final static int typeIndexID = ART_Inverse.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jules.types.ace.ART_Inverse");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public ART_Inverse_Type(JCas jcas, Type casType) {
    super(jcas, casType);
