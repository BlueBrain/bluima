...
public class Relation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jules.types.ace.Relation");
  ...
  public String getTense(int addr) {
      ...
      jcas.throwFeatMissing("tense", "de.julielab.jules.types.ace.Relation");
  ...
  public String getAce_subtype(int addr) {
      ...
      jcas.throwFeatMissing("ace_subtype", "de.julielab.jules.types.ace.Relation");
  ...
  public String getModality(int addr) {
      ...
      jcas.throwFeatMissing("modality", "de.julielab.jules.types.ace.Relation");
  ...
  public String getAce_type(int addr) {
      ...
      jcas.throwFeatMissing("ace_type", "de.julielab.jules.types.ace.Relation");
  ...
  public int getMentions(int addr) {
      ...
      jcas.throwFeatMissing("mentions", "de.julielab.jules.types.ace.Relation");
  ...
  public int getArguments(int addr) {
      ...
      jcas.throwFeatMissing("arguments", "de.julielab.jules.types.ace.Relation");
