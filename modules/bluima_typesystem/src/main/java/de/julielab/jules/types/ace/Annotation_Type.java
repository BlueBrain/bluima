 ...
 * @generated */
public class Annotation_Type extends de.julielab.jules.types.Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jules.types.ace.Annotation");
  ...
  public String getAce_role(int addr) {
      ...
      jcas.throwFeatMissing("ace_role", "de.julielab.jules.types.ace.Annotation");
  ...
  public String getRefid(int addr) {
      ...
      jcas.throwFeatMissing("refid", "de.julielab.jules.types.ace.Annotation");
