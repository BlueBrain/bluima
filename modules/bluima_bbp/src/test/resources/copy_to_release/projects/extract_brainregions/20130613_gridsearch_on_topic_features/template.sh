...
cd /nfs4/bbp.epfl.ch/user/richarde/dev/bluebrain/release_20130613

./bin/run_pipeline pipelines/projects/extract_brainregions/20130613_gridsearch_on_topic_features/20130613_gridsearch_on_features.pipeline %(topNTopics)s
