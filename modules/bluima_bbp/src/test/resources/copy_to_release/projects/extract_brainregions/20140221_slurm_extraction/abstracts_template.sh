...
#SBATCH --output=/nfs4/bbp.epfl.ch/user/richarde/slurm_logs/20140226/%(ner)s%(job_id)s-stdout.log
#SBATCH --error=/nfs4/bbp.epfl.ch/user/richarde/slurm_logs/20140226/%(ner)s%(job_id)s-stdout.log
...
%(job_id)s %(ner)s \
/nfs4/bbp.epfl.ch/simulation/nlp/data/20140226_br_rels_abstracts %(from_id)s %(to_id)s
