...
cd /nfs4/bbp.epfl.ch/user/richarde/dev/bluebrain/release_20130220/
./bin/run_pipeline pipelines/projects/dca/slurm/dca_20130220/preprocess_pubmed.pipeline %(from_id)s %(to_id)s %(job_name)s
