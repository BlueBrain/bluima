...
public class Acronym implements Comparable<Acronym> {
    ...
    public Acronym(String shortForm, String longForm, int start) {
        _shortForm = shortForm;
        _longForm = longForm;
        _start = start;

        _hashCode = (_shortForm + "\t" + _longForm + _start).hashCode();
    }
    ...
    public static class AcronymShortFormComparator implements
            Comparator<Acronym> {
        @Override
    ...
    public static class AcronymFrequencyComparator implements
            Comparator<Acronym> {
        @Override
        public int compare(Acronym t1, Acronym t2) {
