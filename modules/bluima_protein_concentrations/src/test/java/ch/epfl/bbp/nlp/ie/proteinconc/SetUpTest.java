...
public class SetUpTest {
    ...
    @Test
    public void testBrainRegionAnnotatorSetUp() throws Exception {
        ...
        builder.add(BrainRegionAnnotator.class, PARAM_MODEL_FILE, MODEL_FILE);
        builder.process();
    ...
    @Test
    public void testNeuronAnnotatorSetUp() throws Exception {
